...
# 📖 Medical-db <a name="about-project"></a>

**Medical database** In this project, you will use a relational database to create the initial data structure for a vet clinic. You will create a table to store animals' information, insert some data into it, and query it.
...
- `git clone https://github.com/UsirusenIkon/medical-db.git` if your're using https or git 
